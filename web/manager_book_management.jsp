                ...
                <table class="layui-table">
                    ...
                    <c:forEach items="${books}" var="book">
                        <tr>
                            ...
                            <th>
                                <a onclick="update('${book.bno}','${book.bname}','${book.bauthor}','${book.bsource}','${book.bedition}','${book.bprice}','${book.bnum}','${book.course.cname}')"><i class="layui-icon layui-icon-edit"></i></a>
...
<script>
    ...
    function update(bookBno,bookName,bookAuthor,bookSource,bookEdition,bookPrice,bookBnum,bookCname) {
        layer.open({
            type: 1,
            title:'增加库存',
            content:'<div style="padding: 10px"><form class="layui-form layui-form-pane" action="BookServlet">\n' +
                ...
                '                        <input type="text" name="name" required lay-verify="required" value="'+bookName+'" autocomplete="off" class="layui-input"readonly="readonly">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item" pane>\n' +
                '                    <label class="layui-form-label">作者</label>\n' +
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text" name="author" required lay-verify="required" value="'+bookAuthor+'" autocomplete="off" class="layui-input"readonly="readonly">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item" pane>\n' +
                '                    <label class="layui-form-label">出版社</label>\n' +
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text" name="source" required lay-verify="required" value="'+bookSource+'" autocomplete="off" class="layui-input"readonly="readonly">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item" pane>\n' +
                '                    <label class="layui-form-label">版次</label>\n' +
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text" name="edition" required lay-verify="required" value="'+bookEdition+'" autocomplete="off" class="layui-input"readonly="readonly">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item" pane>\n' +
                '                    <label class="layui-form-label">价格</label>\n' +
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text" name="price" required lay-verify="required" value="'+bookPrice+'" autocomplete="off" class="layui-input"readonly="readonly">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item" pane>\n' +
                '                    <label class="layui-form-label">所属课程号</label>\n' +
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text" name="ccno" required lay-verify="required" value="'+bookCname+'" autocomplete="off" class="layui-input"readonly="readonly">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item" pane>\n' +
        ...
        $("#btn_find").click(function () {
            layer.open({
                ...
                content: '<form style="margin: 15px " class="layui-form" action="BookServlet">\n' +
                    ...
                    '                        <div class="layui-input-block">\n' +
                    '                            <input type="text" name="Bcno"   placeholder="" autocomplete="off" class="layui-input">\n' +
                    '                        </div>\n' +
                    '                    </div>\n' +
                    '                    <div class="layui-form-item">\n' +
