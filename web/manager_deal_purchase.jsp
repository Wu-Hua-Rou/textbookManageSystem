            ...
            <div class="layui-card-body">
                <table class="layui-table">
                    ...
                    <c:forEach items="${purchases}" var="purchase">
                        <tr>
                            <th>${purchase.bno}</th>
                            <th>${purchase.bname}</th>
                            <th>${purchase.bauthor}</th>
                            <th>${purchase.bsource}</th>
                            <th>${purchase.bedition}</th>
                            <th>${purchase.bprice}</th>
                            <th>${purchase.number}</th>
                            <th>
                                <button class="layui-btn"style="text-align:right">打印</button>
                            </th>
                        </tr>
                    </c:forEach>
                    </tbody>
